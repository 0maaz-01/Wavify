...
const Admin = () => {
  ...
  const fileChangeHandler = (e) => {
    ...
    // keeping the reference of the file in the setFile variable
    setFile(file);
  };
  ...
  const addAlbumHandler = (e) => {
    ...
    // FormData() is a built-in JavaScript constructor used to create a FormData object, which lets you easily construct
    //  a set of key/value pairs representing form fields and their values — including files — to send using fetch or
    //  XMLHttpRequest.
    const formData = new FormData();

    // append(key, pair) to formData
